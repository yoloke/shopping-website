  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-info">
        ...
        <ol>
          <li>
            掌上豹商城支付平台目前支持<span class="zfb">支付宝</span>支付方式。
          </li>
...
export default {
  ...
  methods: {
    ...
    async open() {
      //生成一个二维码URL
      await QRCode.toDataURL(this.payInfo.codeUrl);
      let url =
        "https://could-img.oss-cn-hangzhou.aliyuncs.com/202209091505294.png";
      //第一个参数:即为内容区域
      //第二个参数:标题
      //第三个参数:组件的配置项
      this.$alert(`<img src=${url}>`, "请您微信扫码支付", {
        ...
        beforeClose: (action, instance, done) => {
          ...
          if (action == "confirm" && this.code == 205) {
            ...
            this.$message.error("支付遇见问题请联系人工客服");
          }
        },
      });
